    ...
    <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info-tab">
      <Form v-slot="{ errors }" @submit="checkBasicInfo">
        <div class="row">
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <Field type="text" class="form-control" id="productTitle"
                    placeholder="請輸入商品標題" v-model="newProduct.title"
            ...
            <div class="mb-3">
              ...
              <Field type="text" class="form-control" id="productDescription"
                    placeholder="請輸入商品描述" v-model="newProduct.description"
          ...
          <div class="col-md-6">
            <div class="row">
              <CategorySelect @emit-category='getCategory' :add="isAdd"></CategorySelect>
              ...
              <div class="col-md-6 mb-3">
                ...
                <Field type="text" class="form-control" id="productUnit"
                      placeholder="請輸入商品單位" v-model="newProduct.unit"
