<template>
  ...
  <div class="d-flex justify-content-end mb-3">
    ...
    <button class="btn btn-primary btn-sm" @click="addCoupon">新增</button>
  </div>
  ...
  <div class="tab-content border-bottom p-4" id="myTabContent">
    ...
    >
      <Form v-slot="{ errors }" @submit="addCoupon">
        <div class="row">
          <div class="col-md-6">
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="couponIsEnabled" class="form-label"
                    >啟用狀態<sup>*</sup></label
                  >
                  <select
                    class="form-select"
          ...
          <div class="col-md-6">
            <label for="couponTitle" class="form-label">內容說明</label>
            <textarea
              type="text"
              class="form-control"
              id="couponTitle"
