<template>
  ...
  <div class="container mb-6" id='intro'>
    <div class="row justify-content-between align-items-center mb-6">
      <div class="col-md-6">
        <div class="row">
          <div class='col'>
            <div class='editImg bg-cover bg-center rounded w-100'
    ...
    <div class="row justify-content-between align-items-center mb-6">
      ...
      <div class="col-md-5 order-md-0">
        <h3 class="fontSizeM fw-bold mb-4">大自然的陽光、乾淨的水源</h3>
        <p>
    ...
    <div class="row justify-content-between align-items-center">
      ...
      <div class="col-md-5">
        <h3 class="fontSizeM fw-bold mb-4">拔除多餘的雜草、配製自然的除蟲劑</h3>
        <p>
          雜草能夠協助平衡田間生態，減少害蟲入侵，但過多的雜草會妨礙作物成長不良，
          為了確保作物能夠獲得充足的養分和水分，同時保留雜草的益處，不使用除草劑，
          而是定時以人力手拔或是鋤頭清除作物週圍多餘的雜草。
          當蟲害過於嚴重時，以菸葉、除蟲菊等天然成分配製成自然農藥，噴灑在作物周圍，
          不會造成藥劑殘留同時降低蟲害，讓作物健康生長。
        </p>
      </div>
    </div>
  </div>
  ...
  <div class='container mb-6'>
    <div class="row justify-content-around align-items-center text-center mb-6">
      <div class="col-md-5">
        <h3 class="fontSizeM fw-bold mb-4">與時間賽跑、當天現採寄出</h3>
        <p class=''>
        ...
        <div class='editImg bg-cover bg-center rounded w-50 mb-3'
        ...
        <div class='editImg bg-cover bg-center rounded w-50 ms-md-auto'
      ...
      <div class="col-md-5">
        <h3 class="fontSizeM fw-bold mb-4">讓土地休息、保持土壤生機</h3>
        <p class=''>
        ...
        <div class='editImg bg-cover bg-center rounded w-50  ms-md-auto mb-3'
        ...
        <div class='editImg bg-cover bg-center rounded w-50'
