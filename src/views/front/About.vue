<template>
  ...
  <div class="container">
    <div class="row justify-content-around align-items-center mb-md-7"
      ...
      <div class="col-md-5">
        <h2 class='fontSizeM text-center mb-3'>部落合作共生、珍惜人與土地的聯繫</h2>
        <p>
    ...
    <div class="row justify-content-around align-items-center mb-md-7"
      ...
      <div class="col-md-5">
        <h2 class='fontSizeM text-center mb-3'>公平貿易、避免剝削</h2>
        <p>
          Original 高山部落蔬果網路平台，主要是提供高山原住民部落的族人直接販售農產品和手工藝品，
    ...
    <div class="row justify-content-around align-items-center mb-md-7"
      ...
      <div class="col-md-5">
        <h2 class='fontSizeM text-center mb-3'>維持部落經濟、消費者享受美食</h2>
        <p class='mb-5'>
        ...
        <div class="d-center">
          <router-link to='/products' class="btn btn-light fontSizeM fw-bold px-4">
            來享受美食吧
          </router-link>
        </div>
      </div>
