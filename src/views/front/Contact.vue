    ...
    <div class="row justify-content-center mb-6">
      <div class="col-md-5">
        ...
        <Form v-slot="{ errors }" @submit='sendEmail'
          ...
          <div class="row justify-content-center mb-3 mb-lg-4">
            <label for="userName" class="col-sm-2 col-form-label">Email<sup>*</sup></label>
            <div class="col-sm-8">
              <Field type="email" class="form-control disabled" id="userName"
          ...
          <div class="row justify-content-center mb-5">
            <label for="userName" class="col-sm-2 col-form-label">詢問事項<sup>*</sup></label>
            <div class="col-sm-8">
              <Field type="text" class="form-control disabled" id="userName"
                  placeholder="請輸入詢問事項"
