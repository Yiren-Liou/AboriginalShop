        ...
        <Form v-slot="{ errors }" @submit="emitOrder">
          <div class="border rounded py-4 px-5 mb-4">
            ...
            <div class="row mb-3">
             ...
             <div class="row mb-3">
              <label for="remarks" class="col-sm-4 col-form-label fontSize-md-S">統一編號</label>
              <div class="col-sm-8">
                <input
                  class="form-control"
                  v-model="user.uniformNumbers"
                  placeholder="請輸入統一編號"
                  id="uniformNumbers"
                >
              </div>
            ...
            <div class="row mb-3">
              <label for="remarks" class="col-sm-4 col-form-label fontSize-md-S">備註</label>
              <div class="col-sm-8">
                <textarea
                  class="form-control"
                  v-model="message"
